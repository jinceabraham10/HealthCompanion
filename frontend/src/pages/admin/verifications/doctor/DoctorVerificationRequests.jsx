...
import { ApproveDoctor, getAllToBeApprovedDoctorsList, rejectDoctor } from "../../../../services/adminService";
...
function RequestListCard(props) {
    ...
    const handleReject=async (e)=>{
        await rejectDoctor({doctorId:props.doctor._id})
        await props.load()  
    ...
    <div className="flex flex-row h-30 w-1/2 ml-10 gap-10 border rounded-lg p-5 shadow-lg">
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-row gap-4">
          <button className="p-4 border bg-red-700 rounded hover:bg-yellow-300 text-white" onClick={handleReject}>
            Reject
          </button>
