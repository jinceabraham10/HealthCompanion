    ...
    <div className='flex flex-col gap-4 w-auto'>
        {
          (displayedPatients.length>0) &&  displayedPatients.map((slot,index)=>(
                <div className='border rounded-lg shadow-lg  p-4 flex flex-row gap-10 mr-10 w-[90%]  ' key={index}>
                    ...
                    <img src={(slot.patientId.realProfileImage)?`data:image/jpeg;base64,${slot.patientId.realProfileImage}`:""} className="border h-[60%] w-[50%] rounded-full" alt="img" />
                    ...
                    <div className='flex flex-col gap-4 w-[70%] h-[50%] bg-gray-100 p-4 '>
