...
export async function getAllDoctors() {
  try {
    const resp = await axios.get(
      "https://healthcompanion.onrender.com:5000/api/doctor/getAllDoctors"
    );
...
export async function verificationFormSubmit(verificationData) {
  try {
    const resp = await axios.post(
      "https://healthcompanion.onrender.com:5000/api/doctor/verificationSubmit",
      verificationData,
      {
        headers: {
...
export async function loadDoctorData({ userId }) {
  try {
    const fetchedDoctorData = await axios.post(
      "https://healthcompanion.onrender.com:5000/api/doctor/getDoctorDetails",
      { userId }
    );
...
export async function AddSlot(slot) {
  try {
    const resp = await axios.post(
      "https://healthcompanion.onrender.com:5000/api/doctor/addSlot",
      slot
    );
...
export async function getSetSlots(doctor) {
  try {
    ...
    const resp = await axios.post("https://healthcompanion.onrender.com:5000/api/doctor/slots", {
      _id,date
    });
    console.log(resp);
...
export async function getBookedPatients(doctor) {
  try {
    ...
    const resp = await axios.post(
      "https://healthcompanion.onrender.com:5000/api/doctor/confirmedSlots",
      { _id:doctorId }
    );
    console.log(resp.data)
...
export async function deleteSlot(slotDetails) {
  try {
    ...
    const resp=await axios.post("https://healthcompanion.onrender.com:5000/api/doctor/deleteSlot",slotDetails)
    await Swal.fire({
      icon:"question",
...
export async function getAllReviewsForADoctor({doctorId}){
  try {
    const resp=await axios.post("https://healthcompanion.onrender.com:5000/api/doctor/getAllReviewsForADoctor",{doctorId})
    console.log(resp.data)
