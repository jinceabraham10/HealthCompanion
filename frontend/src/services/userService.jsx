...
export async function createUser(userData) {
  try {
    ...
    const response = await axios.post(
      "https://healthcompanion.onrender.com:5000/api/user/verifyOtp",
      userData,
      {
...
export async function generateOtp(email) {
  try {
    const response = await axios.post(
      "https://healthcompanion.onrender.com:5000/api/user/generateOtp",
      { email },
      {
        withCredentials: true,
      }
...
export async function bookSlot(bookDetails){
  try {
    ...
    const resp=await axios.post('https://healthcompanion.onrender.com:5000/api/user/bookSlot',bookDetails)
    console.log(resp)
    swal.fire({
      icon:"success",
      title:"Booked",
...
export async function updatePatientProfile(patientData) {
  try {
    ...
    const resp=await axios.post("https://healthcompanion.onrender.com:5000/api/user/updateProfile/patient",patientData)
...
export async function getAllSlotsBooked(userData) {
  try {
    ...
    const resp=await axios.post('https://healthcompanion.onrender.com:5000/api/user/getAllBookedSlots',{patientId:patientId})
...
export async function updatePatientProfileImage(patientData) {
  try {
    await console.log(patientData)
    const resp=await axios.post("https://healthcompanion.onrender.com:5000/api/user/updateProfileImage/patient",patientData,{
      headers:{
...
export async function getSlots(doctor) {
  try {
    ...
    const resp = await axios.post("https://healthcompanion.onrender.com:5000/api/doctor/availableSlots", {
      _id
    });
    console.log(resp);
...
export async function getBookedSlotsForToday(userData) {
  try {
    const {patientId}=userData
    console.log(userData)
    const resp=await axios.post('https://healthcompanion.onrender.com:5000/api/user/getBookedSlotsToday',{patientId:patientId})
    return resp.data.bookedSlots
...
export async function cancelSlot({id}){
  try {
    // console.log(bookDetails)
    const resp=await axios.post('https://healthcompanion.onrender.com:5000/api/user/cancelSlot',{_id:id})
...
export async function getAllCompletedSlot({patientId}){
  try {
    const allCompletedConsultations=await axios.post("https://healthcompanion.onrender.com:5000/api/user/getAllCompletedConsultations",{patientId})
...
export async function addReview(reviewDetails) {
  try {
    const resp=await axios.post("https://healthcompanion.onrender.com:5000/api/user/addReview",reviewDetails)
    console.log(resp.data)
    swal.fire({
      icon:"success",
...
export async function getReview({slotId}) {
  try {
    const resp=await axios.post("https://healthcompanion.onrender.com:5000/api/user/slot/getReview",{slotId})
    console.log(resp.data)
...
export async function editReview(reviewDetails) {
  try {
    const resp=await axios.post("https://healthcompanion.onrender.com:5000/api/user/editReview",reviewDetails)
    console.log(resp.data)
    swal.fire({
      icon:"success",
